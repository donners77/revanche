...
namespace Revanche.Views.Dialogs
{
	public partial class Date
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Revanche.Views.Dialogs.Date
			this.Name = "Revanche.Views.Dialogs.Date";
			this.Title = global::Mono.Unix.Catalog.GetString ("Select Date");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child Revanche.Views.Dialogs.Date.VBox
			...
			w1.Add (this.calendar3);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(w1 [this.calendar3]));
			w2.Position = 0;
			w2.Expand = false;
			w2.Fill = false;
			// Internal child Revanche.Views.Dialogs.Date.ActionArea
